    ...
    <footer className="bg-primary text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4">Бар-да-бар</h3>
            <p className="mb-4">
              Уютное кафе в центре города, где вкусная еда, приятная атмосфера и отличное настроение!
            </p>
          ...
          <div>
            ...
            <address className="not-italic">
              ...
              <p className="mb-2">
                <a href="mailto:info@bardabar.ru" className="hover:text-accent transition-colors">
                  info@bardabar.ru
                </a>
              </p>
            </address>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Кафе "Бар-да-бар". Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
